    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        signUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivityForResult(intentLogin,REGISTER);
            }
        });
...
//        populateAutoComplete();
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            User user = new User();
            user = user.getUserByEmailOrUsername(mEmail);
            user = user.getUserByEmailOrUsername(mEmail);
            // Check if username, password is filled
            if((mEmail.equals(user.getUserName()) || mEmail.equals(user.getEmail()))  && mPassword.equals(services.decrypt(user.getPassword()))){
               if(checkBox.isChecked()){
                   SessionManager session = new SessionManager(getApplicationContext());
                   session.createLoginSession(user.getUserName(), user.getUserId() + "");
               }
