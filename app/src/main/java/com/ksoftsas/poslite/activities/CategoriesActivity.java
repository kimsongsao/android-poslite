...
public class CategoriesActivity extends AppCompatActivity implements CategoryAdapter.CategoryAdapterListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivityForResult(intent,REQUEST_CATEGORY_CARD);
            }
        });
        list = new ArrayList<>();
    ...
    @Override
    public void onCategoryLongSelected(final Category category) {
        new AlertDialog.Builder(this)
            .setTitle("Delete")
            .setMessage("Do you really want to delete " + category.getDescription() +"?")
            .setIcon(android.R.drawable.ic_dialog_alert)
            .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialog, int whichButton) {
                    category.delete(category.getCode());
                    fetchCategories();
                }})
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(requestCode == REQUEST_CATEGORY_CARD && resultCode == RESULT_OK){
            fetchCategories();
        }
    }
}
